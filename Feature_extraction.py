...
def count_strokes(f):
    ...
    initial_timestamp=dat_pat['Timestamp'].iloc[0]
...
def find_velocity(f):
    ...
    initial_timestamp=data_pat['Timestamp'].iloc[0]
    ...
    print ('Number of coordinates:',len(data_pat))
    t = 0
    for i in range(len(data_pat)-2):
        if t+10 <= len(data_pat)-1:
            Vel.append(((data_pat['X'].iloc[t+10] - data_pat['X'].iloc[t])/(data_pat['Timestamp'].iloc[t+10]-data_pat['Timestamp'].iloc[t]) , (data_pat['Y'].iloc[t+10]-data_pat['Y'].iloc[t])/(data_pat['Timestamp'].iloc[t+10]-data_pat['Timestamp'].iloc[t])))
            horz_Vel.append((data_pat['X'].iloc[t+10] - data_pat['X'].iloc[t])/(data_pat['Timestamp'].iloc[t+10]-data_pat['Timestamp'].iloc[t]))
            
            vert_Vel.append((data_pat['Y'].iloc[t+10] - data_pat['Y'].iloc[t])/(data_pat['Timestamp'].iloc[t+10]-data_pat['Timestamp'].iloc[t]))
            magnitude.append(sqrt(((data_pat['X'].iloc[t+10]-data_pat['X'].iloc[t])/(data_pat['Timestamp'].iloc[t+10]-data_pat['Timestamp'].iloc[t]))**2 + (((data_pat['Y'].iloc[t+10]-data_pat['Y'].iloc[t])/(data_pat['Timestamp'].iloc[t+10]-data_pat['Timestamp'].iloc[t]))**2)))
            timestamp_diff.append(data_pat['Timestamp'].iloc[t+10]-data_pat['Timestamp'].iloc[t])
...
def find_acceleration(f):
    ...
    horz_acc_mag = []
    vert_acc_mag = []
    print ('Number of coordinates:',len(Vel))
...
def find_jerk(f):
    ...
    horz_jerk_mag = []
    vert_jerk_mag = []
    print ('Number of coordinates', len(accl))
...
def NCV_per_halfcircle(f):
    ...
    ncv = []
    temp_ncv = 0
    basex = data_pat['X'].iloc[0]
    for i in range(len(data_pat)-2):
        if data_pat['X'].iloc[i] == basex:
            ncv.append(temp_ncv)
        ...
        Vel.append(((data_pat['X'].iloc[i+1] - data_pat['X'].iloc[i])/(data_pat['Timestamp'].iloc[i+1]-data_pat['Timestamp'].iloc[i]) , (data_pat['Y'].iloc[i+1]-data_pat['Y'].iloc[i])/(data_pat['Timestamp'].iloc[i+1]-data_pat['Timestamp'].iloc[i])))
